...
-- Insert movie
INSERT INTO movie ("title", "description", "minimumAge", "favorite", "imageURL", "categoryId")
VALUES ('Mon voisin Totoro',
       ...
       ('Dune : deuxième partie',
        ...
        14, false, 'pasEncoreLeLien2', 1),
       ('Interstellar',
        'Le film raconte les aventures d’un groupe d’explorateurs qui utilisent une faille récemment découverte dans l’espace-temps afin de repousser les limites humaines et partir à la conquête des distances astronomiques dans un voyage interstellaire.',
        NULL, true, 'pasEncoreLeLien3', 2),
       ...
       ('Vice-versa',
        ...
        NULL, false, 'pasEncoreLeLien13', 2);
-- Insert movie
...
VALUES ('2024-11-21 18:00:00', 1, 1),
       ('2024-11-21 18:00:00', 2, 1),
       ('2024-11-21 18:00:00', 3, 1),
       ('2024-11-21 18:00:00', 4, 1),
       ('2024-11-21 18:00:00', 5, 1),
       ('2024-11-21 18:00:00', 1, 2),
       ('2024-11-21 18:00:00', 2, 2),
       ('2024-11-21 18:00:00', 3, 2),
       ('2024-11-21 18:00:00', 4, 2),
       ('2024-11-21 18:00:00', 5, 2);
-- Insert booking
